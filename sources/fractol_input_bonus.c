...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   fractol_input_bonus.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: mpiantan <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/20 11:35:06 by mpiantan          #+#    #+#             */
/*   Updated: 2025/01/29 08:56:04 by mpiantan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	parse_extra_fractals(int argc, char **argv, t_fractal *fractal)
{
	if (argc == 2 && ft_strncmp(argv[1], "burning_ship", 12) == 0
		&& ft_strlen(argv[1]) == 12)
		fractal->type = 3;
	else if (argc == 2 && ft_strncmp(argv[1], "tricorn", 7) == 0
		&& ft_strlen(argv[1]) == 7)
		fractal->type = 4;
	else if (argc == 2 && ft_strncmp(argv[1], "multibrot", 9) == 0
		&& ft_strlen(argv[1]) == 9)
		fractal->type = 5;
	else
		return (0);
...
void	parse_input(int argc, char **argv, t_fractal *fractal)
{
	...
	else if (!parse_extra_fractals(argc, argv, fractal))
	{
